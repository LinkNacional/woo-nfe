        ...
        public function init_form_fields() {
            ...
            $this->form_fields = [
                ...
                'nfe_fiscal_title' => [
                    ...
                    'type' => 'title',
                    'description' => sprintf(
                        __('If you are in doubt on how to fill the fields below, ask for help from you accountant or get in contact with our team via <a href="mailto:%s">%s</a>', 'woo-nfe'),
